...
export const UsageExamples: Story = {
  render: () => html`
    <div style="background-color: #f9fafb; padding: 40px; display: block; overflow-x: auto; width: 100%; box-sizing: border-box; font-family: sans-serif;">
      <div style="background-color: #ffffff; padding: 40px; border-radius: 8px; border: 1px solid #e5e7eb; display: flex; flex-direction: column; gap: 32px; width: fit-content; margin: 0 auto; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);">
